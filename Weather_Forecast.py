...
def data_get():
      city = city_name.get()
      data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=599eaa46d002379ebd384ba2e1823d65").json()
...
win = Tk()
win.title("Weather_Forecast")
win.config(bg = "sky blue")
win.geometry("500x570")

name_label = Label(win,text="Climate Mate", font=("Time New Roman",30,"bold"))
...
com = ttk.Combobox(win,text="Climate Mate",values=list_name, font=("Time New Roman",20,"bold"),textvariable=city_name)
